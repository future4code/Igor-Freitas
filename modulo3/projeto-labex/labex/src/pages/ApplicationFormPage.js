...
export default function ApplicationFormPage() {
    const { form, onChange, cleanTheField} = useForm({
        name: '',
        age: '',
        text: '',
        country: '',
    ...
    const ApplyToTrip = (e) => {
        ...
        axios
            .post(`${URL_BASE}/trips/${form.tripId}/apply`, body)
            .then((res) => {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
    ...
    const chooseTripList = useGetList().map((trips) => {
            ...
            <C.Title>
                ...
                <form onSubmit={ApplyToTrip}>
                    ...
                    <Stack spacing={15} direction="row">
                        <Button variant="contained" type='submit' onClick={goToTrips}>Voltar</Button>
                        <Button variant="contained" type='submit'onClick={ApplyToTrip}>Enviar</Button>
                    </Stack>
                    </C.ButtonForm>
                </form>
        </C.DivForm>
